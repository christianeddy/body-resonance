      ...
      <div className="flex min-h-screen flex-col items-center justify-center px-5">
        <div className="w-full max-w-sm animate-fade-slide-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <input
                ...
                className="w-full rounded-xl border border-input bg-card px-4 py-3.5 font-body text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary transition-colors"
              />
            )}
            <input
              type="email"
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-muted py-3.5 font-body text-sm text-foreground hover:bg-card transition-colors"
          >
